...
function StatCard({ icon: Icon, label, value, colorClass, badge, trend, trendLabel }) {
  // Determine if value is currency or plain number for animation
    ...
    >
      ...
      <div className={styles.statCardBody}>
        ...
        <div className={styles.statValueRow}>
          ...
          {trendLabel && (
            <span className={styles.trendLabelBadge}>{trendLabel}</span>
          )}
        </div>
      </div>
    </motion.div>
